...
def main() -> None:
    ...
    while running:
        for event in pygame.event.get():
            ...
            if game_state == "MENU":
                ...
                if action == "settings_updated" and gm is not None:
                    ...
                    gm.network_client.is_my_turn = False
                    game_state = "GAME"
        ...
        if gm and gm.network_client.connected:
            ...
            # GameManager zbiera WSZYSTKIE pakiety (w tym poprawnie zsynchronizowany turn)
            gm.handle_response()

            # Konsumowanie kolejki zdarzeń GUI wygenerowanych przez GameManager
            try:
                while True:
